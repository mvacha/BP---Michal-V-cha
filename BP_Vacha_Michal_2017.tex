...
\acknowledgements{I would like to thank my supervisor Ing. Petr Máj for being supportive and patient with me and my thesis. Special thanks goes to other members of PRL-PRG laborarory, namely Filip Křikava and Filippo Ghibellini both helped me many times when I was struggeling with difficulties in R. Finally, I would like to thank my family and friends for their support throughout my whole studies. }
\abstractEN{This thesis is a stepping stone towards a greater endeavor: making R faster without breaking compatibility with existing packages. To do that, a tool for test generation called Genthat has been developed. Genthat creates tests from traces of function calls and to do that is has to be able to serialize arbitrary object a function may take as an argument or return as a result. Although R is a functional language and therefore the usage of closures is abundant, they have not been supported in Genthat. In my work, I have implemented the serialization of closures and improved other areas, namely serialization of language expressions and improving the code clarity of generated tests.}

\abstractCS{Tato bakalářská práce je součástí větší snahy, a to udělat R rychlejší bez rozbití zpětné kompatibility. K tomu byl vytvořen nástroj pro automatické generování testů, Genthat. Jeho cílem je trasovat volání funkcí a z těchto záznamů následně vytvořit sadu testů. Aby to bylo možné, je nutné, aby Genthat uměl serializovat libovolný objekt, který může funkce v R přijímat jako parametr nebo vracet. R je funkcionální jazyk, a proto se v něm často používají funkce typu closure, které zachytávají kontext, kde byly vytvořeny. Tyto funkce nebyly dříve v Genthatu podporovány a mým úkolem bylo přidat jejich podporu. Mimo to jsem vylepšil i ostatní části, konkrétně serializaci výrazů a čitelnost výsledných testů.}
